...
- For CLI, local campaign, page JSON, and custom component work, follow `.raisely/raisely-docs.md` and use the `raisely-docs` skill to read Raisely MCP documentation resources.
