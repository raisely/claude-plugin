---
name: raisely-docs
description: Loads Raisely documentation via MCP for the CLI, local campaigns, campaign JSON, custom components, and editor behaviour. Use for any Raisely CLI question, local campaign work, page JSON, components, or when aligning terminology with official docs.
---

# Raisely local development and CLI

Before answering questions or acting on anything related to the **Raisely CLI**, **local campaigns**, **campaign JSON**, **custom components**, or **editor behaviour**, read the relevant documentation using Raisely MCP resources. Treat that as the source of truth for how things work.
